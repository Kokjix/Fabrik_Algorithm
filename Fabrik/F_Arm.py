...
class JOY(object): # joy classı tuşları ve axisleri tutuyor
    ...
    def set_buttons(self, new_button_0, new_button_1, new_button_2, new_button_3, new_button_4,  new_button_5,  new_button_6,  new_button_7,  new_button_8,  new_button_9,  new_button_10,  new_button_11):
        self.buttons[0] = new_buttons_0
        self.buttons[1] = new_buttons_1
        self.buttons[2] = new_buttons_2
        self.buttons[3] = new_buttons_3
        self.buttons[4] = new_buttons_4
        self.buttons[5] = new_buttons_5
        self.buttons[6] = new_button_6
        self.buttons[7] = new_buttons_7
        self.buttons[8] = new_buttons_8
        self.buttons[9] = new_buttons_9
        self.buttons[10] = new_buttons_10
        self.buttons[11] = new_buttons_11
