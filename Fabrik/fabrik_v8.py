...
def joy_callback(msg):
    ...
    arm.delta_thetas[1] = msg.axes[1] * 0.0025  # ikinci eksen
    ...
    arm.delta_thetas[3] = -msg.axes[4] * 0.004 #simülasyon için
    arm.delta_thetas[4] = -msg.axes[7] * 0.003 #simülasyon için
    arm.delta_thetas[5] = msg.axes[6] * 0.006 #simülasyon için
