...
if __name__ == "__main__":
    ...
    my_joints.append([46.3,0.0,26.5])
    #arm = F_ARM()
    ...
    while not rospy.is_shutdown():
        ...
        if not second_part:
            """
            if arm.joint_angles[0] != 0 or arm.joint_angles[1] != 0 or arm.joint_angles[2] != 0:
            ...
            if b:
                ...
                #arm.link_2math.sin(arm.theta[0]+arm.theta[1])+arm.link_1math.sin(arm.theta[0])
                ...
                #arm.link_2math.cos(arm.theta[0]+arm.theta[1])+arm.link_1math.cos(arm.theta[0])
                arm.current_pos[0] = x
                arm.current_pos[1] = y
                arm.current_pos[2] = z
                new_end_point_pos[0] = new_end_point_pos[0] + x + X
                new_end_point_pos[1] = new_end_point_pos[1] + y + Y
                new_end_point_pos[2] = new_end_point_pos[2] + z + Z
                ...
                joint1_last = theta_1 #((joint_angles[0]*math.pi)/180)  
                joint2_last = theta_2 #((joint_angles[1]*math.pi)/180)  
                joint3_last = theta_3 #((joint_angles[2]*math.pi)/180)  
            ...
            if 1 == 0:
                ...
                arm.current_pos[0] = x - 27.3
                arm.current_pos[1] = y
                arm.current_pos[2] = z - 40.5
                ...
                new_end_point_pos = [46.3, 0.0, 26.5]
                new_end_point_pos[0] = new_end_point_pos[0] + X #+ arm.current_pos[0] 
                new_end_point_pos[1] = new_end_point_pos[1] + Y #+ arm.current_pos[0]
                new_end_point_pos[2] = new_end_point_pos[2] + Z #+ arm.current_pos[0]
            ...
            #arm.joint_angles.update_position()
